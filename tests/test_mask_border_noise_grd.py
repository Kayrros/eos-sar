...
def get_noise_calibration_files(pid, pol):
    if pid == 'S1A_IW_GRDH_1SDV_20170601T182708_20170601T182733_016844_01C013_25CB':
        noise_files = ['noise-s1a-iw-grd-vv-20170601t182708-20170601t182733-016844-01c013-001.xml',
                       'noise-s1a-iw-grd-vh-20170601t182708-20170601t182733-016844-01c013-002.xml']
        calibration_files = ['calibration-s1a-iw-grd-vv-20170601t182708-20170601t182733-016844-01c013-001.xml',
    ...
    if pid == 'S1A_IW_GRDH_1SDV_20220510T015404_20220510T015433_043142_05270C_03EA':
        noise_files = ['noise-s1a-iw-grd-vv-20220510t015404-20220510t015433-043142-05270c-001.xml',
                       'noise-s1a-iw-grd-vh-20220510t015404-20220510t015433-043142-05270c-002.xml']
        calibration_files = ['calibration-s1a-iw-grd-vv-20220510t015404-20220510t015433-043142-05270c-001.xml',
    ...
    calibration_file = [calibration_file for calibration_file in calibration_files if pol in calibration_file][0]
...
def get_image_file(pid, pol):
    if pid == 'S1A_IW_GRDH_1SDV_20170601T182708_20170601T182733_016844_01C013_25CB':
        image_files = ['s1a-iw-grd-vv-20170601t182708-20170601t182733-016844-01c013-001.tiff',
                       's1a-iw-grd-vh-20170601t182708-20170601t182733-016844-01c013-002.tiff']

    if pid == 'S1A_IW_GRDH_1SDV_20220510T015404_20220510T015433_043142_05270C_03EA':
        image_files = ['s1a-iw-grd-vv-20220510t015404-20220510t015433-043142-05270c-001.tiff',
...
def get_infos_snap(pid, pol):
    basepath = 's3://kayrros-dev-satellite-test-data/sentinel-1/eos_test_data/test_mask'
    if pol == 'vv' or 'hh':
        snap_reader = io.open_image(f'{basepath}/{pid}_tnr_Bdr.data/Intensity_{pol.upper()}.img')
    else:
...
def compare_masks(mask_arr, mask_snap):
    ...
    assert nb_diff_pixels / nb_pixels * 100. < 1.
...
def test_masks(pol, method):
    ...
    pids = ['S1A_IW_GRDH_1SDV_20170601T182708_20170601T182733_016844_01C013_25CB',
    ...
    for pid in pids:
        ...
        for window in windows:
            ...
            arr = calibrator.calibrate_inplace(image.copy(), roi, method=method, dont_clip_noise=False)
