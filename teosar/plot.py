...
def save_imgs_as_gif(gif_path, images, duration=.1):
    imageio.mimsave(gif_path, images, duration=duration)

def plot_phi(phi, cmap="jet", title="", figsize=None, remove_ticks=True,
             fig_out_path=None, **save_fig_kwargs):
...
def plot_amp(amp, vmin, vmax, title="", figsize=None, remove_ticks=True,
             fig_out_path=None, **save_fig_kwargs):
...
def plot_amp_phi(amp, vmin, vmax, phi, phi_cmap="jet", title="",
                 figsize=None, remove_ticks=True, fig_out_path=None, **save_fig_kwargs):
    ...
    im = axs[1].imshow(phi, cmap=phi_cmap, interpolation="nearest", vmin=-np.pi, vmax=np.pi)
...
def plot_cmpx_interf_rgb(amp, vmin, vmax, phi, title="",
                 figsize=None, remove_ticks=True, fig_out_path=None, **save_fig_kwargs):
