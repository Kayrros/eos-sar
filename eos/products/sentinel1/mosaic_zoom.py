...
from eos.sar import fourier_zoom, utils, regist
...
class MosaicZoomer(regist.SarResample):
    ...
    def __init__(self, mosaic_bsids, mosaic_write_rois,
                 crop_roi, zoom_factor, previous_resamplers):
        """
        ...
        for bsid in self.bsids:
            ...
            self.resampled_resamplers[bsid] = s1.burst_resamp.ResampledBurstResampler(
                src_roi_within_dst_roi=src_roi_within_dst_roi, backward_matrix=backward_matrix,
    ...
    def zoom_fourier(self, deramped):
        ...
        resampled = fourier_zoom.fourier_zoom(
            deramped, self.zoom_factor)
        return resampled
    ...
    def reramp(self, dst_array):
        ...
        """
        assert dst_array.shape == self.dst_shape, "Input array has incompatible shape with expected dst shape."
        ...
        for bsid in self.bsids:
            ...
            reramped[row_min:row_max + 1, col_min:col_max + 1] = self.resampled_resamplers[bsid].reramp(
